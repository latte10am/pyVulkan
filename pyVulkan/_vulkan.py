...
_weakkey_dict = weakref.WeakKeyDictionary()
...
if sys.version_info < (3, 0):
    ffi.cdef(pkg_resources.resource_string(__name__, "_vulkan.h"))
    _castToPtr = _castToPtr2
else:
    ffi.cdef(pkg_resources.resource_string(__name__, "_vulkan.h").decode())
...
PFN_vkDebugReportCallbackEXT = ffi.callback(
    'VkBool32(VkFlags, VkDebugReportObjectTypeEXT, uint64_t, size_t,'
    'int32_t, const char *, const char *, void *)')
PFN_vkAllocationFunction = ffi.callback(
    'void*(void*, size_t, size_t, VkSystemAllocationScope)')
PFN_vkReallocationFunction = ffi.callback(
    'void*(void*, void*, size_t, size_t, VkSystemAllocationScope)')
PFN_vkFreeFunction = ffi.callback('void(void*, void*)')
PFN_vkInternalAllocationNotification = ffi.callback(
    'void(void*, size_t, VkInternalAllocationType, VkSystemAllocationScope)')
...
VK_PIPELINE_CACHE_HEADER_VERSION_RANGE_SIZE = (
    VkPipelineCacheHeaderVersion.VK_PIPELINE_CACHE_HEADER_VERSION_RANGE_SIZE)
VK_PIPELINE_CACHE_HEADER_VERSION_END_RANGE = (
    VkPipelineCacheHeaderVersion.VK_PIPELINE_CACHE_HEADER_VERSION_END_RANGE)
VK_PIPELINE_CACHE_HEADER_VERSION_BEGIN_RANGE = (
    VkPipelineCacheHeaderVersion.VK_PIPELINE_CACHE_HEADER_VERSION_BEGIN_RANGE)
...
VK_SYSTEM_ALLOCATION_SCOPE_RANGE_SIZE = (
    VkSystemAllocationScope.VK_SYSTEM_ALLOCATION_SCOPE_RANGE_SIZE)
VK_SYSTEM_ALLOCATION_SCOPE_END_RANGE = (
    VkSystemAllocationScope.VK_SYSTEM_ALLOCATION_SCOPE_END_RANGE)
VK_SYSTEM_ALLOCATION_SCOPE_BEGIN_RANGE = (
    VkSystemAllocationScope.VK_SYSTEM_ALLOCATION_SCOPE_BEGIN_RANGE)
...
VK_INTERNAL_ALLOCATION_TYPE_RANGE_SIZE = (
    VkInternalAllocationType.VK_INTERNAL_ALLOCATION_TYPE_RANGE_SIZE)
VK_INTERNAL_ALLOCATION_TYPE_END_RANGE = (
    VkInternalAllocationType.VK_INTERNAL_ALLOCATION_TYPE_END_RANGE)
VK_INTERNAL_ALLOCATION_TYPE_BEGIN_RANGE = (
    VkInternalAllocationType.VK_INTERNAL_ALLOCATION_TYPE_BEGIN_RANGE)
...
VK_PHYSICAL_DEVICE_TYPE_RANGE_SIZE = (
    VkPhysicalDeviceType.VK_PHYSICAL_DEVICE_TYPE_RANGE_SIZE)
VK_PHYSICAL_DEVICE_TYPE_END_RANGE = (
    VkPhysicalDeviceType.VK_PHYSICAL_DEVICE_TYPE_END_RANGE)
VK_PHYSICAL_DEVICE_TYPE_BEGIN_RANGE = (
    VkPhysicalDeviceType.VK_PHYSICAL_DEVICE_TYPE_BEGIN_RANGE)
...
VK_COMPONENT_SWIZZLE_RANGE_SIZE = (
    VkComponentSwizzle.VK_COMPONENT_SWIZZLE_RANGE_SIZE)
VK_COMPONENT_SWIZZLE_END_RANGE = (
    VkComponentSwizzle.VK_COMPONENT_SWIZZLE_END_RANGE)
VK_COMPONENT_SWIZZLE_BEGIN_RANGE = (
    VkComponentSwizzle.VK_COMPONENT_SWIZZLE_BEGIN_RANGE)
...
VK_PRIMITIVE_TOPOLOGY_RANGE_SIZE = (
    VkPrimitiveTopology.VK_PRIMITIVE_TOPOLOGY_RANGE_SIZE)
VK_PRIMITIVE_TOPOLOGY_END_RANGE = (
    VkPrimitiveTopology.VK_PRIMITIVE_TOPOLOGY_END_RANGE)
VK_PRIMITIVE_TOPOLOGY_BEGIN_RANGE = (
    VkPrimitiveTopology.VK_PRIMITIVE_TOPOLOGY_BEGIN_RANGE)
...
VK_SAMPLER_MIPMAP_MODE_RANGE_SIZE = (
    VkSamplerMipmapMode.VK_SAMPLER_MIPMAP_MODE_RANGE_SIZE)
VK_SAMPLER_MIPMAP_MODE_END_RANGE = (
    VkSamplerMipmapMode.VK_SAMPLER_MIPMAP_MODE_END_RANGE)
VK_SAMPLER_MIPMAP_MODE_BEGIN_RANGE = (
    VkSamplerMipmapMode.VK_SAMPLER_MIPMAP_MODE_BEGIN_RANGE)
...
VK_SAMPLER_ADDRESS_MODE_END_RANGE = (
    VkSamplerAddressMode.VK_SAMPLER_ADDRESS_MODE_END_RANGE)
VK_SAMPLER_ADDRESS_MODE_BEGIN_RANGE = (
    VkSamplerAddressMode.VK_SAMPLER_ADDRESS_MODE_BEGIN_RANGE)
...
VK_DESCRIPTOR_TYPE_BEGIN_RANGE = (
    VkDescriptorType.VK_DESCRIPTOR_TYPE_BEGIN_RANGE)
...
VK_ATTACHMENT_LOAD_OP_RANGE_SIZE = (
    VkAttachmentLoadOp.VK_ATTACHMENT_LOAD_OP_RANGE_SIZE)
VK_ATTACHMENT_LOAD_OP_END_RANGE = (
    VkAttachmentLoadOp.VK_ATTACHMENT_LOAD_OP_END_RANGE)
VK_ATTACHMENT_LOAD_OP_BEGIN_RANGE = (
    VkAttachmentLoadOp.VK_ATTACHMENT_LOAD_OP_BEGIN_RANGE)
...
VK_ATTACHMENT_STORE_OP_RANGE_SIZE = (
    VkAttachmentStoreOp.VK_ATTACHMENT_STORE_OP_RANGE_SIZE)
VK_ATTACHMENT_STORE_OP_END_RANGE = (
    VkAttachmentStoreOp.VK_ATTACHMENT_STORE_OP_END_RANGE)
VK_ATTACHMENT_STORE_OP_BEGIN_RANGE = (
    VkAttachmentStoreOp.VK_ATTACHMENT_STORE_OP_BEGIN_RANGE)
...
VK_PIPELINE_BIND_POINT_RANGE_SIZE = (
    VkPipelineBindPoint.VK_PIPELINE_BIND_POINT_RANGE_SIZE)
VK_PIPELINE_BIND_POINT_END_RANGE = (
    VkPipelineBindPoint.VK_PIPELINE_BIND_POINT_END_RANGE)
...
VK_COMMAND_BUFFER_LEVEL_RANGE_SIZE = (
    VkCommandBufferLevel.VK_COMMAND_BUFFER_LEVEL_RANGE_SIZE)
VK_COMMAND_BUFFER_LEVEL_END_RANGE = (
    VkCommandBufferLevel.VK_COMMAND_BUFFER_LEVEL_END_RANGE)
VK_COMMAND_BUFFER_LEVEL_BEGIN_RANGE = (
    VkCommandBufferLevel.VK_COMMAND_BUFFER_LEVEL_BEGIN_RANGE)
...
class VkQueryPipelineStatisticFlagBits:
    ...
    VK_QUERY_PIPELINE_STATISTIC_TESSELLATION_EVALUATION_SHADER_INVOCATIONS_BIT = 512  # noqa
...
VK_DEBUG_REPORT_OBJECT_TYPE_RANGE_SIZE_EXT = (
    VkDebugReportObjectTypeEXT.VK_DEBUG_REPORT_OBJECT_TYPE_RANGE_SIZE_EXT)
VK_DEBUG_REPORT_OBJECT_TYPE_END_RANGE_EXT = (
    VkDebugReportObjectTypeEXT.VK_DEBUG_REPORT_OBJECT_TYPE_END_RANGE_EXT)
VK_DEBUG_REPORT_OBJECT_TYPE_BEGIN_RANGE_EXT = (
    VkDebugReportObjectTypeEXT.VK_DEBUG_REPORT_OBJECT_TYPE_BEGIN_RANGE_EXT)
...
VK_DEBUG_REPORT_ERROR_MAX_ENUM_EXT = (
    VkDebugReportErrorEXT.VK_DEBUG_REPORT_ERROR_MAX_ENUM_EXT)
VK_DEBUG_REPORT_ERROR_RANGE_SIZE_EXT = (
    VkDebugReportErrorEXT.VK_DEBUG_REPORT_ERROR_RANGE_SIZE_EXT)
VK_DEBUG_REPORT_ERROR_END_RANGE_EXT = (
    VkDebugReportErrorEXT.VK_DEBUG_REPORT_ERROR_END_RANGE_EXT)
VK_DEBUG_REPORT_ERROR_BEGIN_RANGE_EXT = (
    VkDebugReportErrorEXT.VK_DEBUG_REPORT_ERROR_BEGIN_RANGE_EXT)
...
def _newStruct(ctype, **kwargs):
    ...
    ptrs = {
        k: _castToPtr(
            kwargs[k], dict(
                _type.fields)[k].type) for k in kwargs if dict(
            _type.fields)[k].type.kind == 'pointer'}
...
def VkInstanceCreateInfo(
    ...
    enabledLayerCount=None,
    ppEnabledLayerNames=None,
    enabledExtensionCount=None,
...
def VkImageFormatProperties(
    maxExtent=None,
    maxMipLevels=None,
    maxArrayLayers=None,
    sampleCounts=None,
    maxResourceSize=None,
):
    return _newStruct(
...
def VkPhysicalDeviceLimits(
    maxImageDimension1D=None,
    maxImageDimension2D=None,
    maxImageDimension3D=None,
    maxImageDimensionCube=None,
    maxImageArrayLayers=None,
    maxTexelBufferElements=None,
    maxUniformBufferRange=None,
    maxStorageBufferRange=None,
    maxPushConstantsSize=None,
    maxMemoryAllocationCount=None,
    maxSamplerAllocationCount=None,
    bufferImageGranularity=None,
    sparseAddressSpaceSize=None,
    maxBoundDescriptorSets=None,
    maxPerStageDescriptorSamplers=None,
    maxPerStageDescriptorUniformBuffers=None,
    maxPerStageDescriptorStorageBuffers=None,
    maxPerStageDescriptorSampledImages=None,
    maxPerStageDescriptorStorageImages=None,
    maxPerStageDescriptorInputAttachments=None,
    maxPerStageResources=None,
    maxDescriptorSetSamplers=None,
    maxDescriptorSetUniformBuffers=None,
    maxDescriptorSetUniformBuffersDynamic=None,
    maxDescriptorSetStorageBuffers=None,
    maxDescriptorSetStorageBuffersDynamic=None,
    maxDescriptorSetSampledImages=None,
    maxDescriptorSetStorageImages=None,
    maxDescriptorSetInputAttachments=None,
    maxVertexInputAttributes=None,
    maxVertexInputBindings=None,
    maxVertexInputAttributeOffset=None,
    maxVertexInputBindingStride=None,
    maxVertexOutputComponents=None,
    maxTessellationGenerationLevel=None,
    maxTessellationPatchSize=None,
    maxTessellationControlPerVertexInputComponents=None,
    maxTessellationControlPerVertexOutputComponents=None,
    maxTessellationControlPerPatchOutputComponents=None,
    maxTessellationControlTotalOutputComponents=None,
    maxTessellationEvaluationInputComponents=None,
    maxTessellationEvaluationOutputComponents=None,
    maxGeometryShaderInvocations=None,
    maxGeometryInputComponents=None,
    maxGeometryOutputComponents=None,
    maxGeometryOutputVertices=None,
    maxGeometryTotalOutputComponents=None,
    maxFragmentInputComponents=None,
    maxFragmentOutputAttachments=None,
    maxFragmentDualSrcAttachments=None,
    maxFragmentCombinedOutputResources=None,
    maxComputeSharedMemorySize=None,
    maxComputeWorkGroupCount=None,
    maxComputeWorkGroupInvocations=None,
    maxComputeWorkGroupSize=None,
    subPixelPrecisionBits=None,
    subTexelPrecisionBits=None,
    mipmapPrecisionBits=None,
    maxDrawIndexedIndexValue=None,
    maxDrawIndirectCount=None,
    maxSamplerLodBias=None,
    maxSamplerAnisotropy=None,
    maxViewports=None,
    maxViewportDimensions=None,
    viewportBoundsRange=None,
    viewportSubPixelBits=None,
    minMemoryMapAlignment=None,
    minTexelBufferOffsetAlignment=None,
    minUniformBufferOffsetAlignment=None,
    minStorageBufferOffsetAlignment=None,
    minTexelOffset=None,
    maxTexelOffset=None,
    minTexelGatherOffset=None,
    maxTexelGatherOffset=None,
    minInterpolationOffset=None,
    maxInterpolationOffset=None,
    subPixelInterpolationOffsetBits=None,
    maxFramebufferWidth=None,
    maxFramebufferHeight=None,
    maxFramebufferLayers=None,
    framebufferColorSampleCounts=None,
    framebufferDepthSampleCounts=None,
    framebufferStencilSampleCounts=None,
    framebufferNoAttachmentsSampleCounts=None,
    maxColorAttachments=None,
    sampledImageColorSampleCounts=None,
    sampledImageIntegerSampleCounts=None,
    sampledImageDepthSampleCounts=None,
    sampledImageStencilSampleCounts=None,
    storageImageSampleCounts=None,
    maxSampleMaskWords=None,
    timestampComputeAndGraphics=None,
    timestampPeriod=None,
    maxClipDistances=None,
    maxCullDistances=None,
    maxCombinedClipAndCullDistances=None,
    discreteQueuePriorities=None,
    pointSizeRange=None,
    lineWidthRange=None,
    pointSizeGranularity=None,
    lineWidthGranularity=None,
    strictLines=None,
    standardSampleLocations=None,
    optimalBufferCopyOffsetAlignment=None,
    optimalBufferCopyRowPitchAlignment=None,
    nonCoherentAtomSize=None,
):
    return _newStruct(
...
def VkPhysicalDeviceSparseProperties(
    residencyStandard2DBlockShape=None,
    residencyStandard2DMultisampleBlockShape=None,
    residencyStandard3DBlockShape=None,
    residencyAlignedMipSize=None,
    residencyNonResidentStrict=None,
):
    return _newStruct(
...
def VkPhysicalDeviceProperties(
    apiVersion=None,
    driverVersion=None,
    vendorID=None,
    deviceID=None,
    deviceType=None,
    deviceName=None,
    pipelineCacheUUID=None,
    limits=None,
    sparseProperties=None,
):
    return _newStruct(
...
def VkQueueFamilyProperties(
    queueFlags=None,
    queueCount=None,
    timestampValidBits=None,
    minImageTransferGranularity=None,
):
    return _newStruct(
...
def VkPhysicalDeviceMemoryProperties(
    memoryTypeCount=None,
    memoryTypes=None,
    memoryHeapCount=None,
    memoryHeaps=None,
):
    return _newStruct(
...
def VkSubmitInfo(
    ...
    pNext=None,
    waitSemaphoreCount=None,
    pWaitSemaphores=None,
    pWaitDstStageMask=None,
    commandBufferCount=None,
    pCommandBuffers=None,
    signalSemaphoreCount=None,
...
def VkSparseImageFormatProperties(
    aspectMask=None,
    imageGranularity=None,
    flags=None,
):
    return _newStruct(
...
def VkSparseImageMemoryRequirements(
    formatProperties=None,
    imageMipTailFirstLod=None,
    imageMipTailSize=None,
    imageMipTailOffset=None,
    imageMipTailStride=None,
):
    return _newStruct(
...
def VkSparseImageOpaqueMemoryBindInfo(
        image=None, bindCount=None, pBinds=None, ):
    return _newStruct(
...
def VkBindSparseInfo(
    sType=VK_STRUCTURE_TYPE_BIND_SPARSE_INFO,
    pNext=None,
    waitSemaphoreCount=None,
    pWaitSemaphores=None,
    bufferBindCount=None,
    pBufferBinds=None,
    imageOpaqueBindCount=None,
    pImageOpaqueBinds=None,
    imageBindCount=None,
    pImageBinds=None,
    signalSemaphoreCount=None,
    pSignalSemaphores=None,
...
def VkPipelineCacheCreateInfo(
    sType=VK_STRUCTURE_TYPE_PIPELINE_CACHE_CREATE_INFO,
    pNext=None,
    flags=None,
    initialDataSize=None,
    pInitialData=None,
):
    return _newStruct(
...
def VkPipelineShaderStageCreateInfo(
...
def VkVertexInputBindingDescription(
    binding=None,
    stride=None,
    inputRate=None,
):
...
def VkVertexInputAttributeDescription(
    location=None,
    binding=None,
    format=None,
    offset=None,
...
def VkPipelineVertexInputStateCreateInfo(
    sType=VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO,
    pNext=None,
    flags=None,
    vertexBindingDescriptionCount=None,
    pVertexBindingDescriptions=None,
    vertexAttributeDescriptionCount=None,
...
def VkPipelineInputAssemblyStateCreateInfo(
    sType=VK_STRUCTURE_TYPE_PIPELINE_INPUT_ASSEMBLY_STATE_CREATE_INFO,
    pNext=None,
    flags=None,
    topology=None,
    primitiveRestartEnable=None,
):
    return _newStruct(
...
def VkPipelineTessellationStateCreateInfo(
    sType=VK_STRUCTURE_TYPE_PIPELINE_TESSELLATION_STATE_CREATE_INFO,
    pNext=None,
    flags=None,
    patchControlPoints=None,
):
    return _newStruct(
...
def VkPipelineViewportStateCreateInfo(
...
def VkPipelineRasterizationStateCreateInfo(
    sType=VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_CREATE_INFO,
    pNext=None,
    flags=None,
    depthClampEnable=None,
    rasterizerDiscardEnable=None,
    polygonMode=None,
    cullMode=None,
    frontFace=None,
    depthBiasEnable=None,
    depthBiasConstantFactor=None,
    depthBiasClamp=None,
    depthBiasSlopeFactor=None,
    lineWidth=None,
):
    return _newStruct(
...
def VkPipelineMultisampleStateCreateInfo(
    sType=VK_STRUCTURE_TYPE_PIPELINE_MULTISAMPLE_STATE_CREATE_INFO,
    pNext=None,
    flags=None,
    rasterizationSamples=None,
    sampleShadingEnable=None,
    minSampleShading=None,
    pSampleMask=None,
    alphaToCoverageEnable=None,
    alphaToOneEnable=None,
):
    return _newStruct(
...
def VkPipelineDepthStencilStateCreateInfo(
    sType=VK_STRUCTURE_TYPE_PIPELINE_DEPTH_STENCIL_STATE_CREATE_INFO,
    pNext=None,
    flags=None,
    depthTestEnable=None,
    depthWriteEnable=None,
    depthCompareOp=None,
    depthBoundsTestEnable=None,
    stencilTestEnable=None,
    front=None,
    back=None,
    minDepthBounds=None,
    maxDepthBounds=None,
...
def VkPipelineColorBlendAttachmentState(
    blendEnable=None,
    srcColorBlendFactor=None,
    dstColorBlendFactor=None,
    colorBlendOp=None,
    srcAlphaBlendFactor=None,
    dstAlphaBlendFactor=None,
    alphaBlendOp=None,
    colorWriteMask=None,
):
    return _newStruct(
...
def VkPipelineColorBlendStateCreateInfo(
...
def VkPipelineDynamicStateCreateInfo(
    sType=VK_STRUCTURE_TYPE_PIPELINE_DYNAMIC_STATE_CREATE_INFO,
    pNext=None,
    flags=None,
    dynamicStateCount=None,
    pDynamicStates=None,
):
    return _newStruct(
...
def VkGraphicsPipelineCreateInfo(
    ...
    pInputAssemblyState=None,
    pTessellationState=None,
    pViewportState=None,
    pRasterizationState=None,
    pMultisampleState=None,
    pDepthStencilState=None,
    pColorBlendState=None,
    pDynamicState=None,
    layout=None,
    renderPass=None,
    subpass=None,
    basePipelineHandle=None,
    basePipelineIndex=None,
):
    return _newStruct(
...
def VkComputePipelineCreateInfo(
...
def VkPipelineLayoutCreateInfo(
    sType=VK_STRUCTURE_TYPE_PIPELINE_LAYOUT_CREATE_INFO,
    pNext=None,
    flags=None,
    setLayoutCount=None,
    pSetLayouts=None,
    pushConstantRangeCount=None,
...
def VkDescriptorSetLayoutCreateInfo(
...
def VkDescriptorPoolSize(type=None, descriptorCount=None, ):
    return _newStruct('VkDescriptorPoolSize', type=type,
                      descriptorCount=descriptorCount, )


def VkDescriptorPoolCreateInfo(
...
def VkDescriptorSetAllocateInfo(
    sType=VK_STRUCTURE_TYPE_DESCRIPTOR_SET_ALLOCATE_INFO,
    pNext=None,
    descriptorPool=None,
    descriptorSetCount=None,
    pSetLayouts=None,
):
    return _newStruct(
...
def VkWriteDescriptorSet(
    sType=VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET,
    pNext=None,
    dstSet=None,
    dstBinding=None,
    dstArrayElement=None,
    descriptorCount=None,
    descriptorType=None,
    pImageInfo=None,
    pBufferInfo=None,
...
def VkCopyDescriptorSet(
    sType=VK_STRUCTURE_TYPE_COPY_DESCRIPTOR_SET,
    pNext=None,
    srcSet=None,
    srcBinding=None,
    srcArrayElement=None,
    dstSet=None,
    dstBinding=None,
    dstArrayElement=None,
    descriptorCount=None,
...
def VkSubpassDescription(
    flags=None,
    pipelineBindPoint=None,
    inputAttachmentCount=None,
    pInputAttachments=None,
    colorAttachmentCount=None,
    pColorAttachments=None,
    pResolveAttachments=None,
    pDepthStencilAttachment=None,
    preserveAttachmentCount=None,
...
def VkCommandBufferAllocateInfo(
...
def VkCommandBufferInheritanceInfo(
    sType=VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_INFO,
    pNext=None,
    renderPass=None,
    subpass=None,
    framebuffer=None,
    occlusionQueryEnable=None,
    queryFlags=None,
    pipelineStatistics=None,
):
    return _newStruct(
...
def VkBufferImageCopy(
    bufferOffset=None,
    bufferRowLength=None,
    bufferImageHeight=None,
    imageSubresource=None,
    imageOffset=None,
    imageExtent=None,
):
    return _newStruct(
...
def VkBufferMemoryBarrier(
    sType=VK_STRUCTURE_TYPE_BUFFER_MEMORY_BARRIER,
    pNext=None,
    srcAccessMask=None,
    dstAccessMask=None,
    srcQueueFamilyIndex=None,
    dstQueueFamilyIndex=None,
    buffer=None,
    offset=None,
    size=None,
):
...
def VkRenderPassBeginInfo(
    sType=VK_STRUCTURE_TYPE_RENDER_PASS_BEGIN_INFO,
    pNext=None,
    renderPass=None,
    framebuffer=None,
    renderArea=None,
    clearValueCount=None,
    pClearValues=None,
):
    return _newStruct(
...
def VkDrawIndexedIndirectCommand(
    indexCount=None,
    instanceCount=None,
    firstIndex=None,
    vertexOffset=None,
...
def VkSurfaceCapabilitiesKHR(
    ...
    maxImageExtent=None,
    maxImageArrayLayers=None,
    supportedTransforms=None,
    currentTransform=None,
    supportedCompositeAlpha=None,
    supportedUsageFlags=None,
):
    return _newStruct(
...
def VkSwapchainCreateInfoKHR(
    ...
    minImageCount=None,
    imageFormat=None,
    imageColorSpace=None,
    imageExtent=None,
    imageArrayLayers=None,
    imageUsage=None,
    imageSharingMode=None,
    queueFamilyIndexCount=None,
    pQueueFamilyIndices=None,
    preTransform=None,
    compositeAlpha=None,
...
def VkDisplayPropertiesKHR(
    display=None,
    displayName=None,
    physicalDimensions=None,
    physicalResolution=None,
    supportedTransforms=None,
    planeReorderPossible=None,
    persistentContent=None,
):
    return _newStruct(
...
def VkDisplayModeCreateInfoKHR(
...
def VkDisplayPlaneCapabilitiesKHR(
    supportedAlpha=None,
    minSrcPosition=None,
    maxSrcPosition=None,
    minSrcExtent=None,
...
def VkDisplaySurfaceCreateInfoKHR(
    sType=VK_STRUCTURE_TYPE_DISPLAY_SURFACE_CREATE_INFO_KHR,
    pNext=None,
    flags=None,
    displayMode=None,
    planeIndex=None,
    planeStackIndex=None,
    transform=None,
    globalAlpha=None,
    alphaMode=None,
    imageExtent=None,
...
def VkDebugReportCallbackCreateInfoEXT(
...
def VkXlibSurfaceCreateInfoKHR(
...
def VkWaylandSurfaceCreateInfoKHR(
...
def VkAndroidSurfaceCreateInfoKHR(
...
def VkWin32SurfaceCreateInfoKHR(
...
if hasattr(_lib, 'vkEnumeratePhysicalDevices'):
    def vkEnumeratePhysicalDevices(instance, ):
        ...
        ret = _callApi(
            _lib.vkEnumeratePhysicalDevices,
            instance,
            pPhysicalDeviceCount,
            ffi.NULL)
        _raiseException(ret)
        pPhysicalDevices = ffi.new(
...
if hasattr(_lib, 'vkGetPhysicalDeviceFeatures'):
    def vkGetPhysicalDeviceFeatures(physicalDevice, ):
        ...
        _callApi(
            _lib.vkGetPhysicalDeviceFeatures,
            physicalDevice,
            pFeatures,
        )
        return pFeatures[0]
...
if hasattr(_lib, 'vkGetPhysicalDeviceFormatProperties'):
    def vkGetPhysicalDeviceFormatProperties(physicalDevice, format, ):
        ...
        _callApi(_lib.vkGetPhysicalDeviceFormatProperties,
...
if hasattr(_lib, 'vkGetPhysicalDeviceImageFormatProperties'):
    def vkGetPhysicalDeviceImageFormatProperties(
        ...
        ret = _callApi(
            _lib.vkGetPhysicalDeviceImageFormatProperties,
            physicalDevice,
            format,
            type,
            tiling,
...
if hasattr(_lib, 'vkGetPhysicalDeviceProperties'):
    def vkGetPhysicalDeviceProperties(physicalDevice, ):
        ...
        _callApi(
            _lib.vkGetPhysicalDeviceProperties,
            physicalDevice,
            pProperties,
        )
...
if hasattr(_lib, 'vkGetPhysicalDeviceQueueFamilyProperties'):
    def vkGetPhysicalDeviceQueueFamilyProperties(physicalDevice, ):
        ...
        _callApi(
            _lib.vkGetPhysicalDeviceQueueFamilyProperties,
            physicalDevice,
            pQueueFamilyPropertyCount,
            ffi.NULL)
        pQueueFamilyProperties = ffi.new(
            'VkQueueFamilyProperties[]',
...
if hasattr(_lib, 'vkGetPhysicalDeviceMemoryProperties'):
    def vkGetPhysicalDeviceMemoryProperties(physicalDevice, ):
        ...
        _callApi(_lib.vkGetPhysicalDeviceMemoryProperties,
...
if hasattr(_lib, 'vkEnumerateInstanceExtensionProperties'):
    def vkEnumerateInstanceExtensionProperties(pLayerName, ):
        ...
        ret = _callApi(
            _lib.vkEnumerateInstanceExtensionProperties,
            pLayerName,
            pPropertyCount,
            ffi.NULL)
        _raiseException(ret)
...
if hasattr(_lib, 'vkEnumerateDeviceExtensionProperties'):
    def vkEnumerateDeviceExtensionProperties(physicalDevice, pLayerName, ):
        pPropertyCount = ffi.new('unsigned int *')
        ret = _callApi(
            _lib.vkEnumerateDeviceExtensionProperties,
            physicalDevice,
            pLayerName,
            pPropertyCount,
            ffi.NULL)
...
if hasattr(_lib, 'vkEnumerateInstanceLayerProperties'):
    def vkEnumerateInstanceLayerProperties():
        pPropertyCount = ffi.new('unsigned int *')
        ret = _callApi(
            _lib.vkEnumerateInstanceLayerProperties,
            pPropertyCount,
            ffi.NULL)
        _raiseException(ret)
...
if hasattr(_lib, 'vkEnumerateDeviceLayerProperties'):
    def vkEnumerateDeviceLayerProperties(physicalDevice, ):
        pPropertyCount = ffi.new('unsigned int *')
        ret = _callApi(
            _lib.vkEnumerateDeviceLayerProperties,
            physicalDevice,
            pPropertyCount,
            ffi.NULL)
        _raiseException(ret)
...
if hasattr(_lib, 'vkFlushMappedMemoryRanges'):
    def vkFlushMappedMemoryRanges(device, memoryRangeCount, pMemoryRanges, ):
        ret = _callApi(
            _lib.vkFlushMappedMemoryRanges,
            device,
            memoryRangeCount,
            pMemoryRanges,
        )
...
if hasattr(_lib, 'vkInvalidateMappedMemoryRanges'):
    def vkInvalidateMappedMemoryRanges(
        ...
        ret = _callApi(
            _lib.vkInvalidateMappedMemoryRanges,
            device,
            memoryRangeCount,
            pMemoryRanges,
        )
...
if hasattr(_lib, 'vkGetDeviceMemoryCommitment'):
    def vkGetDeviceMemoryCommitment(device, memory, ):
        ...
        _callApi(
            _lib.vkGetDeviceMemoryCommitment,
            device,
            memory,
...
if hasattr(_lib, 'vkGetBufferMemoryRequirements'):
    def vkGetBufferMemoryRequirements(device, buffer, ):
        ...
        _callApi(_lib.vkGetBufferMemoryRequirements,
...
if hasattr(_lib, 'vkGetImageMemoryRequirements'):
    def vkGetImageMemoryRequirements(device, image, ):
        pMemoryRequirements = ffi.new('VkMemoryRequirements *')
        _callApi(_lib.vkGetImageMemoryRequirements,
...
if hasattr(_lib, 'vkGetImageSparseMemoryRequirements'):
    def vkGetImageSparseMemoryRequirements(device, image, ):
        ...
        _callApi(
            _lib.vkGetImageSparseMemoryRequirements,
            device,
            image,
            pSparseMemoryRequirementCount,
            ffi.NULL)
        pSparseMemoryRequirements = ffi.new(
            'VkSparseImageMemoryRequirements[]',
...
if hasattr(_lib, 'vkGetPhysicalDeviceSparseImageFormatProperties'):
    def vkGetPhysicalDeviceSparseImageFormatProperties(
        ...
        pPropertyCount = ffi.new('unsigned int *')
        _callApi(
            _lib.vkGetPhysicalDeviceSparseImageFormatProperties,
            physicalDevice,
            format,
            type,
            samples,
...
if hasattr(_lib, 'vkGetImageSubresourceLayout'):
    def vkGetImageSubresourceLayout(device, image, pSubresource, ):
        ...
        _callApi(
            _lib.vkGetImageSubresourceLayout,
            device,
            image,
            pSubresource,
            pLayout,
...
if hasattr(_lib, 'vkCreateGraphicsPipelines'):
    def vkCreateGraphicsPipelines(
        ...
        ret = _callApi(
            _lib.vkCreateGraphicsPipelines,
            device,
            pipelineCache,
            createInfoCount,
            pCreateInfos,
...
if hasattr(_lib, 'vkCreateDescriptorSetLayout'):
    def vkCreateDescriptorSetLayout(device, pCreateInfo, pAllocator, ):
        ...
        ret = _callApi(_lib.vkCreateDescriptorSetLayout, device,
...
if hasattr(_lib, 'vkDestroyDescriptorSetLayout'):
    def vkDestroyDescriptorSetLayout(
        ...
        _callApi(
            _lib.vkDestroyDescriptorSetLayout,
            device,
            descriptorSetLayout,
            pAllocator,
        )
...
if hasattr(_lib, 'vkGetRenderAreaGranularity'):
    def vkGetRenderAreaGranularity(device, renderPass, ):
        ...
        _callApi(_lib.vkGetRenderAreaGranularity,
...
if hasattr(_lib, 'vkCmdSetStencilCompareMask'):
    def vkCmdSetStencilCompareMask(commandBuffer, faceMask, compareMask, ):
        _callApi(
            _lib.vkCmdSetStencilCompareMask,
            commandBuffer,
            faceMask,
            compareMask,
        )
...
if hasattr(_lib, 'vkCmdClearDepthStencilImage'):
    def vkCmdClearDepthStencilImage(
        ...
        _callApi(
            _lib.vkCmdClearDepthStencilImage,
            commandBuffer,
            image,
            imageLayout,
            pDepthStencil,
...
if hasattr(_lib, 'vkCmdCopyQueryPoolResults'):
    def vkCmdCopyQueryPoolResults(
        ...
        _callApi(
            _lib.vkCmdCopyQueryPoolResults,
            commandBuffer,
            queryPool,
            firstQuery,
            queryCount,
